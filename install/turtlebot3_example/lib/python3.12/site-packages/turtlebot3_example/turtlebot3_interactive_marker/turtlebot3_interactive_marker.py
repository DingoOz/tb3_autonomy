    ...
    def publish_cmd_vel(self):
        ...
        if self.goal_position is not None:
            ...
            if distance < 0.01:
                ...
                twist_stamped.twist.linear.x = max(-0.1, min(0.1, forward_speed))
                twist_stamped.twist.linear.y = max(-0.1, min(0.1, lateral_speed))
            ...
            if abs(yaw_diff) < 0.01:
                ...
                twist_stamped.twist.angular.z = max(-0.5, min(0.5, yaw_diff))
