...
class Turtlebot3AbsoluteMove(Node):
    ...
    def timer_callback(self):
        ...
        if distance > 0.05:
            ...
            self.cmd_vel.twist.angular.z = path_angle
            self.cmd_vel.twist.linear.x = min(self.linear_speed * distance, 0.1)

            self.cmd_vel.twist.angular.z = max(min(self.cmd_vel.twist.angular.z, 1.5), -1.5)
            ...
            self.cmd_vel.twist.angular.z = turn_speed if self.heading_error > 0 else -turn_speed
